...
public class RoleService : IRoleService
{
  ...
  public async Task<Result<UserProfileResponse>> AssignRoleAsync(AssignRoleRequest assignRoleRequest)
  {
    var validationResult = await _assignRoleValidator.ValidateAsync(assignRoleRequest);
    ...
    var user = await _userManager.FindByNameAsync(assignRoleRequest.UserName);
    if (user == null)
    ...
    result = await _userManager.AddToRolesAsync(user, assignRoleRequest.Roles);
